    ...
    <div className="page">
      <div className="page-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <Link to="/settings" style={{ color: 'var(--text3)', fontSize: 18, textDecoration: 'none', lineHeight: 1, padding: 4 }}>←</Link>
          <div>
            <div className="page-title">QR LABELS</div>
            <div className="page-subtitle">Select items to print</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: '16px 16px 0' }}>
        {loadingTree ? (
          ...
          <>
            ...
            {/* Checklist */}
            <div className="card" style={{ margin: '0 0 16px', padding: '4px 14px', maxHeight: '55dvh', overflowY: 'auto' }}>
              {tree.map(item => (
                <label
                  key={item.key}
                  style={{
